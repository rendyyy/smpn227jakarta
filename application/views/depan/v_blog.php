              ...
              <?php echo $this->session->flashdata('msg');?>
                        ...
                        <article class="blog_item">
                            <div class="blog_item_img">
                                <img class="card-img rounded-0" src="<?php echo base_url().'assets/images/berita/'.$row->tulisan_gambar;?>" alt="<?php echo $row->tulisan_judul;?>">
                            ...
                            <div class="blog_details">
                                ...
                                <ul class="blog-info-link">
                                    <li><i class="fa fa-pencil-square-o"></i> <?php echo $row->tulisan_kategori_nama;?></li>
                                    <li><i class="fa fa-user"></i> <?php echo $row->tulisan_author;?></li>
                                </ul>
                            </div>
                        </article>
                        <?php endforeach;?>
                    ...
                    <?php endforeach;?>
                        ...
                        <aside class="single_sidebar_widget popular_post_widget">
                            ...
                            <div class="media post_item">
                                <img width="35%" class="img-fluid" src="<?php echo base_url().'assets/images/berita/'.$row->tulisan_gambar;?>" alt="post">
