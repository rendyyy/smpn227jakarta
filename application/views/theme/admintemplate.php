...
<head>
  ...
  <meta name="description" content="Sistem Informasi SMPN 227 Jakarta">
  <meta name="author" content="Eduction Technology">

  <title><?php echo isset($breadcrumb) ? $breadcrumb : ''; ?></title>
  <link rel= "shortcut icon" type="image/x-icon" href="<?php echo base_url('');?>style/img/logosmp.ico">
